...
Initial Splunkbase-targeted release. The Aegis app surfaces runtime AI-
...
- **Sourcetype** `cisco_ai_defense:aegis_verdict` for HEC-ingested
  Aegis verdicts (OTel `gen_ai.evaluation.result` events).
...
https://github.com/Blockchain-Oracle/aegis/releases
