...
When  grep -E "^\[Aegis - (Code Detection|Harassment|Hate Speech|PCI|PHI|PII|Prompt Injection|Profanity|Sexual Content & Exploitation|Social Division & Polarization|Violence & Public Safety Threats)\]" runs
...
test "$(grep -cE '^\[Aegis - (Code Detection|Harassment|Hate Speech|PCI|PHI|PII|Prompt Injection|Profanity|Sexual Content & Exploitation|Social Division & Polarization|Violence & Public Safety Threats)\]$' splunk_apps/aegis_app/default/risk_factors.conf)" -eq 11
